...
Task 07C follows [ADR-016](03-architecture/adr/ADR-016-route-supply-decision-readiness-layers.md): Planning is available; Quotation and [Propagation](03-architecture/adr/ADR-018-pre-1-0-supply-decision-event-propagation.md) are implemented on stacked review branches but not main. Task 08 is designed-not-implemented and remains blocked.
