...
| 08-B2/C | UC-INV-002/003 | FR-INV-010~016 | Trade Order outcome consumption、release/consume application operations | reservation query and order workflow | release/consume idempotency、API/UI、E2E | Designed / blocked |
