...
| 08-C1 | UC-INV-002/003 | FR-INV-010~016 | ADR-023、V17 command/audit、release/consume savepoint transaction | 无新增 HTTP/Event 契约 | replay/payload conflict、partial/final、rollback、tenant/permission、20-way same-key 与 8-way competing PostgreSQL concurrency | Implemented in review |
| 08-C2 | UC-INV-002/003 | FR-INV-010~016 | tenant-scoped Reservation API、warehouse-assignment exact 投影与 Order workbench | OpenAPI 1.8/generated TypeScript；release/consume Idempotency-Key | `InventoryReservationApiIntegrationTest`、`ReservationOperationsPanel.test.tsx`、真实 OIDC/PostgreSQL `trade-order-conversion.live.spec.ts` | Implemented in review |
