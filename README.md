...
> **Project status — Idempotent quote-to-order conversion available**
...
> eventual quotation linking, and tenant/Partner-scoped order views. Inventory reservation and later
